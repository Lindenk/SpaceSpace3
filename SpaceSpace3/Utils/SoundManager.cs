...
namespace Utils
{
    ...
    static class SoundManager
    {
        ...
        private static void listUpdate()
        {
            ...
            while(true)
            {
                if ((Main.Game1.g_game.gametime.TotalGameTime.TotalMilliseconds - startTime) > (currentSongDuration - 2000))
                {
        ...
        public static void PlaySong(Musics m)
        {
            ...
            if (currentMusic != null)
            {
                ...
                try
                {
                    startTime = Main.Game1.g_game.gametime.TotalGameTime.TotalMilliseconds;
                }
                catch { }
